...
```json
{
  "applicationName" : "tanzu-csharp-weatherforecast",
  "projectName" : "tanzu-csharp-weatherforecast"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ Debug Startup.cs matched [**] -> included
...
┃ ┃ ┃ ┃ ┃ Debug Startup.cs didn't match [README.md, Sample.csproj, config/**, catalog/**] -> included
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [Sample->tanzu-csharp-weather...(truncated)]
...
┃ ┃ ┃ ┃ ┃ Debug Startup.cs didn't match [Sample.csproj] -> excluded
...
┃ ┃ ┃ ┗ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'tanzu-csharp-weatherforecast.csproj'
...
┃ ┃ ┃ ┃ ┃ Debug Startup.cs didn't match [README.md, config/*.yaml, catalog/*.yaml] -> excluded
...
┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [sample-app->tanzu-csharp-weather...(truncated)]
